...
import { Control, SubmitHandler, UseFormHandleSubmit, UseFormWatch } from 'react-hook-form';
        ...
        >
            <Box sx={style}>
                ...
                <PasswordVerification
                    disabled={(editedData.name === 'password' && watchFields[0] !== watchFields[1]) ? true : false}
                    formRef={formRef}
